import numpy as np
import numerics5_lonzarich as num
...
if (run_simpson):
    ...
    # It is used in adaptive simpon's method even though we probably wouldn't use it alone.
...
if(run_adaptivequad):
    ...
    # It's an interesting take on recursion though it has no safety stopping criterion for the recursion.
